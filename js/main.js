...
/* harmony import */ var _components_headerHeight_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/headerHeight.js */ "./src/js/components/headerHeight.js");
/* harmony import */ var _components_mobileMenu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/mobileMenu.js */ "./src/js/components/mobileMenu.js");
/* harmony import */ var _components_calculator_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/calculator.js */ "./src/js/components/calculator.js");
...
/* harmony import */ var _components_scroll_link_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/scroll-link.js */ "./src/js/components/scroll-link.js");
/* harmony import */ var _components_forms_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/forms.js */ "./src/js/components/forms.js");
/* harmony import */ var _components_reviewSlider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/reviewSlider.js */ "./src/js/components/reviewSlider.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  sliderDay: document.querySelector('#slider-days'),
  sliderMounth: document.querySelector('#slider-mounth'),
  sliderMarker: document.querySelectorAll('.noUi-marker'),
  total: document.querySelector('.calculator__total-number'),
  reviewSlider: document.querySelector('.review__cards')
});
...
var sliderDay = _vars__WEBPACK_IMPORTED_MODULE_1__["default"].sliderDay;
var sliderMounth = _vars__WEBPACK_IMPORTED_MODULE_1__["default"].sliderMounth;
var calcTotal = _vars__WEBPACK_IMPORTED_MODULE_1__["default"].total;

var initSliderDay = function initSliderDay() {
  nouislider__WEBPACK_IMPORTED_MODULE_0__.create(sliderDay, {
    start: [10],
    connect: [true, false],
    range: {
      'min': 5,
  ...
  var pips = sliderDay.querySelectorAll('.noUi-value');
  clickOnPip(sliderDay, pips);
  showMarkers(sliderDay);
};

var initSliderMounth = function initSliderMounth() {
  nouislider__WEBPACK_IMPORTED_MODULE_0__.create(sliderMounth, {
    start: [5],
    connect: [true, false],
    range: {
      'min': 1,
  ...
  var pips = sliderMounth.querySelectorAll('.noUi-value');
...
function showMarkers(slider) {
  slider.noUiSlider.on('update', function (values) {
    var sliderValues = slider.querySelectorAll('.noUi-value');
    var currentValue = values.toString().slice(0, -3);
    slider.querySelectorAll('.noUi-marker').forEach(function (el) {
      el.style.display = "";
    });
    sliderValues.forEach(function (el) {
...
initSliderDay();
initSliderMounth();
[sliderDay, sliderMounth].forEach(function (el) {
  el.noUiSlider.on('update', function () {
    var dayValue = sliderDay.noUiSlider.get();
    var mounthValue = sliderMounth.noUiSlider.get();
    var total = Number(dayValue) * 3000 * 30 * Number(mounthValue) - Number(dayValue) * 3000 * 30 * Number(mounthValue) / 1.21;
...
/***/ "./src/js/components/reviewSlider.js":
/*!*******************************************!*\
  !*** ./src/js/components/reviewSlider.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
_vars__WEBPACK_IMPORTED_MODULE_1__["default"].reviewSlider.classList.add('swiper');

_vars__WEBPACK_IMPORTED_MODULE_1__["default"].reviewSlider.querySelector('.review__cards-wrapper').classList.add('swiper-wrapper');

_vars__WEBPACK_IMPORTED_MODULE_1__["default"].reviewSlider.querySelectorAll('.review__card').forEach(function (el) {
